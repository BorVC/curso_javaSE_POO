...
public class Test11Ordenacion {
	...
	public static void main(String[] args) {
		...
		//y si tienen el mismo número de caracteres, entonces las ordenas
		//alfabeticamente
		...
		//SIN variables forma más compacta
		Arrays.stream(textos)
		.sorted(Comparator.comparingInt((String c) -> c.length()).thenComparing((a,b)->a.compareTo(b)))
		.forEach(System.out::println);
	}
